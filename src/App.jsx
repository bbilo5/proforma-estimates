          ...
          <div className="bg-white shadow-md rounded-xl p-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-3xl font-normal text-black">{cpmRange}</p>
              </div>
              <div>
                <p className="text-sm text-[#e50C00] uppercase font-medium">Cost per View</p>
                <p className="text-3xl font-normal text-black">{cpvRange}</p>
              </div>
              <div>
                <p className="text-sm text-[#e50C00] uppercase font-medium">Impressions</p>
                <p className="text-3xl font-normal text-black">{formatNumber(impressions1)}</p>
              </div>
              <div>
                <p className="text-sm text-[#e50C00] uppercase font-medium">Households</p>
                <p className="text-3xl font-normal text-black">{formatNumber(impressions1 * 0.1986)} - {formatNumber(impressions1 * 0.3333)}</p>
              </div>
              <div>
                <p className="text-sm text-[#e50C00] uppercase font-medium">Web Visits</p>
                <p className="text-3xl font-normal text-black">{formatNumber(impressions1 * 0.00685)} - {formatNumber(impressions1 * 0.01485)}</p>
              </div>
              <div>
                <p className="text-sm text-[#e50C00] uppercase font-medium">Sales</p>
                <p className="text-3xl font-normal text-black">{formatNumber(impressions1 * 0.00854)} - {formatNumber(impressions1 * 0.0429)}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 px-6">
          ...
          <div className="bg-white shadow-md rounded-xl p-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                <p className="text-sm text-[#e50C00] uppercase font-medium">Impressions</p>
                <p className="text-3xl font-normal text-black">{formatNumber(impressions2)}</p>
              </div>
              <div>
                <p className="text-sm text-[#e50C00] uppercase font-medium">Estimated Visits</p>
                <p className="text-3xl font-normal text-black">{formatNumber(visits2)}</p>
              </div>
              <div>
                <p className="text-sm text-[#e50C00] uppercase font-medium">Estimated Sales</p>
                <p className="text-3xl font-normal text-black">{formatNumber(sales2)}</p>
              </div>
              <div>
